...
"""
Me-page, presentation of bjvi13 (bwi) as a sample of a me-page.
...
Mitt namn är Björn Viklund född och
tillbringat mina första ~20år i mellersta Sverige,
Norrlands inland Östersund till Storuman.
Tyvärr så gick det utför för mig efter tonåren . . hamnade i Stocklms
...
http://dbwebb.se/python/me/kmom01/me.php
